...
function AdicionarAquecedor(idsala, nome, btus, potencia)
{
    ...
    {
        GerarNotificacao('Houve um erro ao encontrar a sala.', 'danger');
    }
}
...
$("#tbody-aquecedores").on('click', '.btn-excluir-aquecedor', function()
{
    ...
    linha.remove();
    GerarNotificacao("Aquecedor removido com sucesso", 'success');
});
...
$("#tbody-arcondicionados").on('click', '.btn-excluir-arcondicionado', function()
{
    ...
    linha.remove();
    GerarNotificacao("Ar condicionado removido com sucesso", 'success');
});
...
$("#form-configuracoes-sala").on('submit', function()
{
    ...
    if(sala)
    {
        ...
        GerarNotificacao("Configurações salvas com sucesso", 'success');
    }
    else
    {
        GerarNotificacao("Houve um erro ao salvar as configurações.", 'danger');
    }
});
...
function SetTabelaConexoes(id)
{
    ...
    {
        GerarNotificacao('Houve um erro ao encontrar a sala. Atualize a página.', 'danger');
    }
...
$("#tbody-conexoes").on('click', '.btn-excluir-conexao', function()
{
    ...
    linha.remove();
    SetSelectConexoes();
    GerarNotificacao("Conexão removida com sucesso.","success");
});
...
$("#form-adicionar-conexao-sala").on('submit', function()
{
    ...
    if(info.conexao)
    {
        ...
        GerarNotificacao("Conexão adicionada com sucesso", 'success');
    }
    else
    {
        GerarNotificacao("Conexão não selecionada", 'warning');
    }
